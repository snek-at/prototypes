...
//> Modules
import { ProfileUpload } from "../../modals";
    ...
    return (
      ...
      >
        ...
        >
          ...
          Settings
          {this.state.avatar_url && !this.state.avatar_url.includes("github") &&
          <MDBBtn color="green" onClick={this.save} className="save-button">
              Save
          </MDBBtn>
          }
        </MDBModalHeader>
                        ...
                        <div {...getRootProps()} className="avatar">
                          <MDBView>
                            ...
                            <MDBMask className="flex-center">
                              <MDBIcon icon="camera" size="2x" className="white-text"/> 
                            </MDBMask>
                          </MDBView>
                        </div>
                      )}
      ...
      {this.state.showUpload &&
        <Suspense fallback={<div>Loading...</div>}>
          <ProfileUpload 
            ...
            closeModalProfile={this.handleUploadClose}
          />
        </Suspense>
      }
      </>

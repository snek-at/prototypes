...
/** @class A client implementation for web interaction like scraping or api v4 access */
class WebClient extends Client {
  public scraper: ScraperEndpoint;
  constructor(url: string, headers: object = {}, type: string = "scraper") {
    super({ type, url, headers });
...
//#region > Exports
export { SnekClient, GithubClient, GitlabClient, WebClient };
//#endregion
